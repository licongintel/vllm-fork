...
class HPUModelRunnerBase:
    ...
    def warmup_scenario(self,
        ...
        logger.error("HPU warmup requires an overhaul. Bypassing self.execute_model.")
        if is_prompt:
            seqs = [
...
class HPUModelRunner(HPUModelRunnerBase):
    """
    ...
    def execute_model(
        ...
        raise NotImplementedError("execute_model is not implemented for HPU v1 engine")
